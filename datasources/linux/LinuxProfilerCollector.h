...
#define PROFILER(func_name) file.write(func_name); \
    ...
    void onStart(QVector<QString> protocols) override {
        ...
        if (protocols.contains("udplite")) {
            PROFILER("udplite_checksum_init");
            PROFILER("udplite_csum");
            PROFILER("udplite_csum_outgoing");
            PROFILER("udplite_getfrag");
            PROFILER("udplite_sk_init");
            PROFILER("udplite4_proc_exit_net");
            PROFILER("udplite4_proc_init");
            PROFILER("udplite4_proc_init_net");
            PROFILER("udplite4_register");
            PROFILER("udplite_err");
            PROFILER("udplite_rcv");
        }

        if (protocols.contains("icmp")) {
            PROFILER("__icmp_send");
            PROFILER("icmp_build_probe");
            PROFILER("icmp_discard");
            PROFILER("icmp_echo");
            PROFILER("icmp_err");
            PROFILER("icmp_get_route_lookup_dev");
            PROFILER("icmp_global_allow");
            PROFILER("icmp_glue_bits");
            PROFILER("icmp_init");
            PROFILER("icmp_ndo_send");
            PROFILER("icmp_out_count");
            PROFILER("icmp_push_reply");
            PROFILER("icmp_rcv");
            PROFILER("icmp_redirect");
            PROFILER("icmp_reply");
            PROFILER("icmp_route_lookup");
            PROFILER("icmp_sk");
            PROFILER("icmp_sk_exit");
            PROFILER("icmp_sk_init");
            PROFILER("icmp_socket_deliver");
            PROFILER("icmp_tag_validation");
            PROFILER("icmp_timestamp");
            PROFILER("icmp_unreach");
            PROFILER("icmp_xmit_lock");
            PROFILER("icmp_xmit_unlock");
            PROFILER("icmpv4_global_allow");
            PROFILER("icmpv4_mask_allow");
            PROFILER("icmpv4_xrlim_allow");
            PROFILER("ip_icmp_error_rfc4884");
            PROFILER("ip_icmp_error_rfc4884_validate");
        }

        if (protocols.contains("sctp")) {
            PROFILER("__sctp_packet_append_chunk");
            PROFILER("sctp_packet_append_chunk");
            PROFILER("sctp_packet_append_data");
            PROFILER("sctp_packet_bundle_auth");
            PROFILER("sctp_packet_bundle_pad");
            PROFILER("sctp_packet_bundle_sack");
            PROFILER("sctp_packet_can_append_data");
            PROFILER("sctp_packet_config");
            PROFILER("sctp_packet_free");
            PROFILER("sctp_packet_gso_append");
            PROFILER("sctp_packet_init");
            PROFILER("sctp_packet_pack");
            PROFILER("sctp_packet_reset");
            PROFILER("sctp_packet_transmit");
            PROFILER("sctp_packet_transmit_chunk");
            PROFILER("sctp_packet_will_fit");

            PROFILER("__sctp_hash_endpoint");
            PROFILER("__sctp_lookup_association");
            PROFILER("__sctp_rcv_asconf_lookup");
            PROFILER("__sctp_rcv_init_lookup");
            PROFILER("__sctp_rcv_lookup");
            PROFILER("__sctp_rcv_lookup_endpoint");
            PROFILER("__sctp_rcv_lookup_harder");
            PROFILER("__sctp_rcv_walk_lookup");
            PROFILER("__sctp_unhash_endpoint");
            PROFILER("sctp_add_backlog");
            PROFILER("sctp_addrs_lookup_transport");
            PROFILER("sctp_backlog_rcv");
            PROFILER("sctp_epaddr_lookup_transport");
            PROFILER("sctp_err_finish");
            PROFILER("sctp_err_lookup");
            PROFILER("sctp_has_association");
            PROFILER("sctp_hash_cmp");
            PROFILER("sctp_hash_endpoint");
            PROFILER("sctp_hash_key");
            PROFILER("sctp_hash_obj");
            PROFILER("sctp_hash_transport");
            PROFILER("sctp_hashfn");
            PROFILER("sctp_icmp_frag_needed");
            PROFILER("sctp_icmp_proto_unreachable");
            PROFILER("sctp_icmp_redirect");
            PROFILER("sctp_lookup_association");
            PROFILER("sctp_rcv");
            PROFILER("sctp_rcv_checksum");
            PROFILER("sctp_rcv_ootb");
            PROFILER("sctp_transport_hashtable_destroy");
            PROFILER("sctp_transport_hashtable_init");
            PROFILER("sctp_udp_v4_err");
            PROFILER("sctp_unhash_endpoint");
            PROFILER("sctp_unhash_transport");
            PROFILER("sctp_v4_err");
            PROFILER("sctp_v4_err_handle");
        }

        if (protocols.contains("mptcp")) {
            PROFILER("__mptcp_add_ext");
            PROFILER("__mptcp_alloc_tx_skb");
            PROFILER("__mptcp_check_push");
            PROFILER("__mptcp_check_send_data_fin");
            PROFILER("__mptcp_clean_una");
            PROFILER("__mptcp_clean_una_wakeup");
            PROFILER("__mptcp_clear_xmit");
            PROFILER("__mptcp_close_ssk");
            PROFILER("__mptcp_close_subflow");
            PROFILER("__mptcp_data_acked");
            PROFILER("__mptcp_destroy_sock");
            PROFILER("__mptcp_do_alloc_tx_skb");
            PROFILER("__mptcp_flush_join_list");
            PROFILER("__mptcp_init_sock");
            PROFILER("__mptcp_mem_reclaim_partial");
            PROFILER("__mptcp_move_skb");
            PROFILER("__mptcp_move_skbs");
            PROFILER("__mptcp_move_skbs_from_subflow");
            PROFILER("__mptcp_nmpc_socket");
            PROFILER("__mptcp_ofo_queue");
            PROFILER("__mptcp_push_pending");
            PROFILER("__mptcp_recvmsg_mskq");
            PROFILER("__mptcp_retrans");
            PROFILER("__mptcp_retransmit_pending_data");
            PROFILER("__mptcp_rmem_reclaim");
            PROFILER("__mptcp_set_timeout");
            PROFILER("__mptcp_socket_create");
            PROFILER("__mptcp_splice_receive_queue");
            PROFILER("__mptcp_subflow_push_pending");
            PROFILER("__mptcp_update_rmem");
            PROFILER("__mptcp_wr_shutdown");
            PROFILER("dfrag_clear");
            PROFILER("dfrag_uncharge");
            PROFILER("move_skbs_to_msk");
            PROFILER("mptcp_accept");
            PROFILER("mptcp_alloc_tx_skb");
            PROFILER("mptcp_bind");
            PROFILER("mptcp_cancel_work");
            PROFILER("mptcp_carve_data_frag");
            PROFILER("mptcp_check_allowed_size");
            PROFILER("mptcp_check_and_set_pending");
            PROFILER("mptcp_check_close_timeout");
            PROFILER("mptcp_check_data_fin");
            PROFILER("mptcp_check_data_fin_ack");
            PROFILER("mptcp_check_fastclose");
            PROFILER("mptcp_check_for_eof");
            PROFILER("mptcp_check_readable");
            PROFILER("mptcp_check_writeable");
            PROFILER("mptcp_clean_una_wakeup");
            PROFILER("mptcp_cleanup_rbuf");
            PROFILER("mptcp_close");
            PROFILER("mptcp_close_ssk");
            PROFILER("mptcp_close_state");
            PROFILER("mptcp_close_wake_up");
            PROFILER("mptcp_copy_inaddrs");
            PROFILER("mptcp_data_queue_ofo");
            PROFILER("mptcp_data_ready");
            PROFILER("mptcp_destroy");
            PROFILER("mptcp_destroy_common");
            PROFILER("mptcp_disconnect");
            PROFILER("mptcp_dispose_initial_subflow");
            PROFILER("mptcp_do_flush_join_list");
            PROFILER("mptcp_drop");
            PROFILER("mptcp_enter_memory_pressure");
            PROFILER("mptcp_finish_connect");
            PROFILER("mptcp_finish_join");
            PROFILER("mptcp_flush_join_list");
            PROFILER("mptcp_forward_alloc_get");
            PROFILER("mptcp_frag_can_collapse_to");
            PROFILER("mptcp_get_port");
            PROFILER("mptcp_hash");
            PROFILER("mptcp_inet6_sk");
            PROFILER("mptcp_init_sock");
            PROFILER("mptcp_is_tcpsk");
            PROFILER("mptcp_listen");
            PROFILER("mptcp_mem_reclaim_partial");
            PROFILER("mptcp_napi_poll");
            PROFILER("mptcp_ooo_try_coalesce");
            PROFILER("mptcp_page_frag_refill");
            PROFILER("mptcp_pending_data_fin");
            PROFILER("mptcp_pending_data_fin_ack");
            PROFILER("mptcp_poll");
            PROFILER("mptcp_proto_init");
            PROFILER("mptcp_proto_v6_init");
            PROFILER("mptcp_push_release");
            PROFILER("mptcp_rcv_space_adjust");
            PROFILER("mptcp_rcv_space_init");
            PROFILER("mptcp_recvmsg");
            PROFILER("mptcp_release_cb");
            PROFILER("mptcp_reset_timer");
            PROFILER("mptcp_retransmit_timer");
            PROFILER("mptcp_rfree");
            PROFILER("mptcp_rmem_charge");
            PROFILER("mptcp_rmem_schedule");
            PROFILER("mptcp_rmem_uncharge");
            PROFILER("mptcp_schedule_work");
            PROFILER("mptcp_send_ack");
            PROFILER("mptcp_sendmsg");
            PROFILER("mptcp_sendmsg_frag");
            PROFILER("mptcp_set_datafin_timeout");
            PROFILER("mptcp_set_nospace");
            PROFILER("mptcp_set_owner_r");
            PROFILER("mptcp_set_timeout");
            PROFILER("mptcp_shutdown");
            PROFILER("mptcp_sk_clone");
            PROFILER("mptcp_skb_can_collapse_to");
            PROFILER("mptcp_sock_graft");
            PROFILER("mptcp_stop_timer");
            PROFILER("mptcp_stream_accept");
            PROFILER("mptcp_stream_connect");
            PROFILER("mptcp_subflow_active");
            PROFILER("mptcp_subflow_cleanup_rbuf");
            PROFILER("mptcp_subflow_could_cleanup");
            PROFILER("mptcp_subflow_early_fallback");
            PROFILER("mptcp_subflow_eof");
            PROFILER("mptcp_subflow_get_retrans");
            PROFILER("mptcp_subflow_get_send");
            PROFILER("mptcp_subflow_process_delegated");
            PROFILER("mptcp_subflow_recv_lookup");
            PROFILER("mptcp_subflow_send_ack");
            PROFILER("mptcp_subflow_set_active");
            PROFILER("mptcp_subflow_shutdown");
            PROFILER("mptcp_sync_mss");
            PROFILER("mptcp_timeout_from_subflow");
            PROFILER("mptcp_timeout_timer");
            PROFILER("mptcp_timer_pending");
            PROFILER("mptcp_try_coalesce");
            PROFILER("mptcp_unhash");
            PROFILER("mptcp_update_data_checksum");
            PROFILER("mptcp_update_post_push");
            PROFILER("mptcp_v6_destroy");
            PROFILER("mptcp_wnd_end");
            PROFILER("mptcp_worker");
        }
...
#undef PROFILER
    ...
    QStringList getSupportedProtocols() override {
        return {"ip", "tcp", "udp", "udplite", "sctp", "igmp", "mptcp"};
    }
